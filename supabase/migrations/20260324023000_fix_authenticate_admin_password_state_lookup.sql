-- Repair authenticate_admin after aligning it with admin_sessions.
-- The previous version compiled, but the password-state lookup used an
-- ambiguous identifier at runtime.
