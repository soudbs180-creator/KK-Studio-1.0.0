            ...
            {isOpen && (
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            background: isMobile ? 'var(--bg-secondary)' : 'var(--frost-card-main-bg)',
                            borderColor: isMobile ? 'var(--border-light)' : 'var(--frost-card-main-border)',
                        }}
                    >
                                ...
                                <>
                                    ...
                                    <div className="flex-1 min-w-0 flex items-center justify-center px-2">
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 max-w-full group hover:bg-[var(--toolbar-hover)] px-2.5 py-1 rounded-lg transition-colors cursor-text justify-center"
                                            title="点击重命名"
                                        >
                                            <span className="font-semibold text-sm text-[var(--text-primary)] truncate text-center">
                                    ...
                                    <div className="flex items-center gap-1 shrink-0">
                                        <button
                                            ...
                                            className="p-2 text-[var(--text-secondary)] hover:text-[var(--primary)] hover:bg-[var(--primary-light)] rounded-lg transition-colors flex items-center justify-center shrink-0"
                                            title="新建对话"
                                        >
                                            <Plus size={18} />
                                        </button>
                                        <button
                                            ...
                                            className={`p-2 rounded-lg transition-colors flex items-center justify-center shrink-0 ${showHistoryPanel ? 'text-[var(--primary)] bg-[var(--primary-light)]' : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--toolbar-hover)]'}`}
                                            title="历史记录与分支"
                                        >
                                            <Layout size={18} />
                                        </button>
