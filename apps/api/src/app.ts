...
export const apiModules: ApiModuleDefinition[] = [
  {
    ...
    layers: {
      ...
      infrastructure: "PostgreSQL-backed identity, browser session, and persistence adapters",
    },
  ...
  },
  {
    ...
    currentSources: ["src/services/llm", "src/services/image", "src/services/video", "apps/api/src/modules/model-proxy"],
  },
  {
    name: "workflow",
  ...
  },
  {
    ...
    currentSources: ["src/components/settings", "src/services/model/adminModelService.ts", "scripts/postgres/bootstrap-kk-vps.sql"],
  },
  {
    name: "storage-sync",
    ...
    layers: {
      ...
      infrastructure: "OPFS, file system, and self-hosted storage adapters",
    },
