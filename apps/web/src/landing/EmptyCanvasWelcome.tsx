...
export const EmptyCanvasWelcome: React.FC<EmptyCanvasWelcomeProps> = ({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 p-6">
      <div className="w-full max-w-2xl rounded-3xl border border-[#e5e5e5] bg-white/70 backdrop-blur-md p-8 md:p-12 shadow-sm pointer-events-auto flex flex-col items-center text-center transition-all duration-300">
