    ...
    <SettingsViewShell>
      <div className="settings-reference-stack">
        ...
        >
          ...
          {/* 简体中文注释：下方：磨砂高保真控制台配置选项面板，支持本地化翻译 */}
          <div className="settings-console-panel">
            <div className="settings-console-title">{pick('控制台设置选项', 'Console Configuration Options')}</div>
            <div className="settings-console-grid">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  />
                  <span className="settings-console-label">{pick('显示网络消息', 'Show Network Messages')}</span>
                </div>
                <div 
                  className="settings-console-item"
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('折叠相似消息', 'Group Similar Messages')}</span>
                </div>
                <div 
                  className="settings-console-item"
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('过滤 CORS 错误', 'Filter CORS Errors')}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('记录 XMLHttpRequests', 'Log XMLHttpRequests')}</span>
                </div>
                <div 
                  className="settings-console-item"
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('预估算求值', 'Eager Evaluation')}</span>
                </div>
                <div 
                  className="settings-console-item"
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('历史记录自动补全', 'Autocomplete From History')}</span>
                </div>
                <div 
                  className="settings-console-item"
                ...
                >
                  <input 
                    ...
                    className="settings-console-checkbox" 
                  />
                  <span className="settings-console-label">{pick('以用户身份执行表达式', 'Evaluate Expressions As User')}</span>
                </div>
              </div>
            </div>
          </div>
