...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { name: '12AI NanoBanana', url: 'https://12ai.org', baseUrl: 'https://cdn.12ai.org', format: 'gemini', color: '#eab308', modelId: 'gemini-3.1-flash-image-preview', logoName: '12ai', kind: 'relay', keyLinks: [{ labelZh: '获取 API Key', labelEn: 'Get API Key', url: 'https://cdn.12ai.org' }] },
