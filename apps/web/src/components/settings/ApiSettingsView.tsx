...
const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { name: 'Wuyin Keji Google Omni', url: 'https://api.wuyinkeji.com/doc/72', baseUrl: 'https://api.wuyinkeji.com/api/async/video_google_omni', format: 'openai', color: '#0891b2', modelId: 'video_google_omni', logoName: 'wuyin google omni', kind: 'relay', keyLinks: [{ labelZh: '获取 API Key', labelEn: 'Get API Key', url: 'https://api.wuyinkeji.com/user/key' }, { labelZh: '接口文档', labelEn: 'API docs', url: 'https://api.wuyinkeji.com/doc/72' }] },
