...
- Next slice after M58 is compiler/source-proven unused cleanup narrowed to `src/components/layout/PromptBar.tsx` and `src/components/image/ImageCard2.tsx`; do not touch `src/App.tsx` unless a fresh diagnostic produces App-specific proof.
