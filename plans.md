...
- Next slice after M59 should be separate proof for `src/App.tsx` compiler/source-proven unused cleanup or the next mapped Stage Two seam; do not mix App cleanup with PromptBar/ImageCard cleanup.
