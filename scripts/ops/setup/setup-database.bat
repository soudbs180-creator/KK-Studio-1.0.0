...
echo [2/6] Applying VPS PostgreSQL bootstrap...
...
echo [3/6] Applying AI assistant user scope migration...
...
echo [4/6] Applying Agent Run event migration...
...
echo [5/6] Applying Agent Session migration...
...
echo [6/6] Applying Agent Run Session binding migration...
