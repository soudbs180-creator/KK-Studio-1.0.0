...
3. For Stage Two, split one responsibility at a time from the largest files; the next CanvasContext slice is the startup prompt recovery boundary unless source inspection identifies a smaller safer seam.
