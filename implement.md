...
3. For Stage Two, split one responsibility at a time from the largest files; the current slice is source-proven unused-code cleanup in `CanvasContext.tsx`.
