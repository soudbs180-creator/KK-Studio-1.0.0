...
3. For Stage Two, split or prune one responsibility at a time from the largest files; the active candidate is the M58 unreachable OpenAI image fallback cleanup in `src/services/llm/OpenAICompatibleAdapter.ts`.
