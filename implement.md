...
3. For Stage Two, split or prune one responsibility at a time from the largest files; after the current App cleanup, the next candidate is a freshly mapped OpenAI/keyManager/PromptBar seam or another file-specific noUnused cleanup slice.
