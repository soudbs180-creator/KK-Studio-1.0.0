...
3. For Stage Two, split or prune one responsibility at a time from the largest files; the active candidate is OpenAI-compatible image-routing error classifier extraction in `src/services/llm/OpenAICompatibleAdapter.ts`.
