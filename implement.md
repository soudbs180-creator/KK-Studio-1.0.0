...
3. For Stage Two, split one responsibility at a time from the largest files; the active CanvasContext slice is the workflow source node ID resolver only.
