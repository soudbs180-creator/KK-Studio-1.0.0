...
3. For Stage Two, split one responsibility at a time from the largest files; the current slice is duplicate selected-arrange cleanup in `CanvasContext.tsx`.
