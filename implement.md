...
3. For Stage Two, split one responsibility at a time from the largest files; the current slice is selected-group arrange extraction from `CanvasContext.tsx`.
