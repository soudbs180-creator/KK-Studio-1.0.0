...
3. For Stage Two, split one responsibility at a time from the largest files; the current slice is the image-node deletion transform inside the prompt-image link helper boundary.
