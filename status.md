...
- Next exact step: choose the next narrow non-UI Stage Two slice from the remaining-work candidates; current priority is prompt optimizer cache redaction because it is a focused service/logging boundary with no browser-visible UI change.
