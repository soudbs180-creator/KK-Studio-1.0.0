...
3. 上述 gate 通过后再扩展视频/音频 Worker；Phase 3 下一纵向切片先定义 Chat attachment Asset 引用、TokenBudget 与摘要语义，再建立安全写投影并激活现有 owner-enforced Run/Session binding，不与 pending Job discovery 混入同一提交。
