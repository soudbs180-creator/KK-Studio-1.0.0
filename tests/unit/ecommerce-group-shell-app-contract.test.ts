...
test('ecommerce analysis confirmation creates both main-image and A+ group shells before child nodes', () => {
  ...
  assert.match(appSource, /sourceSheet: '主图'/);
  assert.match(appSource, /sourceSheet: 'A\+'/);
});
